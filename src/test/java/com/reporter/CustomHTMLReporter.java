...
public class CustomHTMLReporter implements IReporter {
    ...
    private static final String emailableReportTemplateFile = "/home/user/IdeaProjects/TestNG/src/test/java/com/reporter/customHTMLReporter.html";
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
        ...
        try
        {
            ...
            File targetFile = new File(outputDirectory + "/customHTMLReporter.html");
